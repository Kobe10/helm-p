package com.bjshfb.vf.client.expos.ffmpeg.FFmpegCommandManager.util;
...
public class PropertiesUtil {
	...
	public static InputStream getInputStream(String path) throws FileNotFoundException {
		return new PropertiesUtil().getInput("/" + path);
	}
	...
	private InputStream getInput(String filePath) {
		//获取文件名称
