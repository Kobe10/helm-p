package com.bjshfb.vf.client.expos.ffmpeg.FFmpegCommandManager.service;
		...
		try {
			if (paramMap.containsKey("ffmpegPath")) {
				...
				if (paramMap.containsKey("input") && paramMap.containsKey("output") && paramMap.containsKey("appName")
					...
					String output1 = (String) paramMap.get("output1");
					...
					if ("0".equals(twoPart)) {
						...
						if ("2".equals(twoPart)) {
							...
							comm.append(" -vcodec copy  -f flv -an ").append(output1 + appName);
						}
					}
