...
import com.bjshfb.vf.client.ipc.org.onvif.ver20.ptz.wsdl.*;
...
public class PtzDevices implements Serializable {
	 ...
	 * @param zoom
	 *            Zoom
	 * @see (), getTiltSpaces(), getZoomSpaces()
...
//		System.out.println("==============ptz222" + new Date().getTime() / 1000);
//		PTZNode node = getNode(profileToken);
//		System.out.println("==============ptz222" + new Date().getTime() / 1000);
//
//		if (node != null) {
