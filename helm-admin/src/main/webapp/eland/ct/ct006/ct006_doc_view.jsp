...
<div id="notOpen" style="text-align: center;" class="mart20 hidden">
    ...
    <a class="link" style="font-size: 18px;display: inline-block; margin-right: 10px;"
       href="<%=PageOfficeLink.openWindow(request, "ct005-printDoc.gv?LOGIN_ACCEPT=" + sessionKey +"&docFileUrl=" + docFileUrl, "width=1024px;height=768px;title=文件打印")%>">
        打开文档
    </a>
...
<script type="text/javascript">
    ...
    function reloadInfo() {
        var ct006DocIFrame = window.parent.frames["ct006DocIFrame"];
        if (ct006DocIFrame && typeof  ct006DocIFrame != undefined) {
            ct006DocIFrame.document.location.reload();
        }
    }
