...
//                增加控制按钮，导航、缩放
        ...
        hrjc_1 = new OpenLayers.Layer.WMS(
                "hrjc:hrjc_1", "http://192.168.1.200:8080/geoserver/hrjc/wms",
                {
...
//        linelayer = new OpenLayers.Layer.Vector("线图层");
        polygonLayer = new OpenLayers.Layer.Vector("多边形图层");
...
//            var linestring = new OpenLayers.Geometry.LineString(pointList); //坐标数组
            ...
            //5、生成线图层
            polygonLayer.addFeatures([lineFeature]);
        }

        // 6、加入图层到地图
        map.addLayers([hrjc_1, hrjc_2, polygonLayer]);
