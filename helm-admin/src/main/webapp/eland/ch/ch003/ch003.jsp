...
<head>
    ...
    <script id="systemScript" contextPath="${pageContext.request.contextPath}/"
            ...
            type="text/javascript"></script>    <oframe:script src="${pageContext.request.contextPath}/eland/ch/ch003/js/ch003.js" type="text/javascript"/>
</head>
<body>
<div class="messageLogging">
    ...
    <table>
        ...
        <tr>
            ...
            <td class="tdTitle">可选面积：</td>
            <td class="tdResult"> ${areaSize} (㎡)</td>
        </tr>
        </tbody>
    </table>
    <div class="bottomList">
        ...
        <span class="schValue">
            <input type="hidden" name="hsJush"/>
            <input type="text" itemCd="NEW_HS_JUSH" atOption="ch003cx.getCfgDataOpt"
...
<div style="position: absolute;bottom: 30px; right:15px;width: 400px;background-color: white;border: 1px solid #7EC4CC;display: none;">
    <table class="border" width="100%">
        <tr>
            <td style="text-align: center;background-color: #3d91c8;font-weight: bolder;color: white;font-size: 20px">本次查询倒计时</td>
        </tr>
        <tr>
