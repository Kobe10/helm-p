                                            ...
                                            <c:choose>
                                                <c:when test="${house.Row.NewHsInfo.statusCd != null}">
                                                    ...
                                                    <label style="background-color: ${newHsColorMap[hsStatus]}; position: relative;"
                                                           onclick="ch001.selectHs('${house.Row.NewHsInfo.newHsId}','${house.Row.NewHsInfo.hsAddr}','${house.Row.NewHsInfo.hsHxName}','${house.Row.NewHsInfo.hsTp}','${house.Row.NewHsInfo.preBldSize}',this)"
                                                           title="${house.Row.NewHsInfo.hsAddr}">
                                                            ${house.Row.NewHsInfo.hsNm}<br>
