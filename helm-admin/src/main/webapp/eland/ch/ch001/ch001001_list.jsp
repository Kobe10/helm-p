    ...
    <table class="table" width="100%">
        ...
        <c:forEach items="${returnList}" var="item" varStatus="varStatus">
            ...
            <tr class="${tr_class}" style="cursor:default;"
                ondblclick="ch001.lbiao('${item.Row.NewHsInfo.newHsId}','${item.Row.NewHsInfo.hsAddr}','${item.Row.NewHsInfo.hsHxName}','${item.Row.NewHsInfo.hsTp}','${item.Row.NewHsInfo.preBldSize}',this)">
                ...
                <td>
                    <a onclick="ch001.selectHs('${item.Row.NewHsInfo.newHsId}','${item.Row.NewHsInfo.hsAddr}','${item.Row.NewHsInfo.hsHxName}','${item.Row.NewHsInfo.hsTp}','${item.Row.NewHsInfo.preBldSize}',this)">
