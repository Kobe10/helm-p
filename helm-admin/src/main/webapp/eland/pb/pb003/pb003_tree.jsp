...
<div class="pageNav">
    ...
    <a class="link" href="javascript:void(0)">外聘成本</a>
</div>
...
<div style="margin: 5px">
    <div id="pb003TreePanel" style="width: 240px;float: left;" layoutH="15"
         class="panel left_menu">
        <h1>
            <span>目 录 导 航</span>
        </h1>
        <ul id="pb003Tree" class="ztree" layoutH="100"></ul>
    </div>
    <div class="split_line" onm layoutH="15">
        <span class="split_but" title="展开/隐藏导航"></span>
    </div>
    <div id="pb003Context" style="margin-left: 250px;"></div>
</div>
<oframe:script src="${pageContext.request.contextPath}/eland/pb/pb003/js/pb003.js" type="text/javascript"/>
