...
<form id="pb003yzfForm">
    ...
    <input type="hidden" name="divId" value="pb003yzf_list">
    ...
    <input type="hidden" name="forward" id="forward" value="/eland/pb/pb003/pb003_yzf_list"/>
</form>
...
<script type="text/javascript">
    $(document).ready(function () {
        Page.query($("#pb003yzfForm", navTab.getCurrentPanel()), '');
    });
</script>
