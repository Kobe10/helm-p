...
<div class="tabs mart5" style="padding: 0">
    <div class="tabsHeader">
        <div class="tabsHeaderContent" style="padding: 0">
            <ul>
                <li class="js_load_tab selected" onclick="pb003.loadTabContext(this);"
                    url="eland/pb/pb003/pb003-initWzf.gv?extCmpId=${extCmpId}">
                    <a href="javascript:"><span>待支付院落</span></a>
                </li>
                <li class="js_load_tab" onclick="pb003.loadTabContext(this);"
                    url="eland/pb/pb003/pb003-initYzf.gv?extCmpId=${extCmpId}">
                    <a href="javascript:"><span>已支付院落</span></a>
                </li>
                <li class="js_load_tab" onclick="pb003.loadTabContext(this);"
                    url="eland/pb/pb003/pb003-initFuze.gv?extCmpId=${extCmpId}">
                    <a href="javascript:"><span>负责院落</span></a>
                </li>
                <li class="js_load_tab" onclick="pb003.loadTabContext(this);"
                    url="eland/pb/pb003/pb003-initZfjl.gv?extCmpId=${extCmpId}">
                ...
                <span class="js_PayButton"
                      ...
                      onclick="pb003.paySelectBuild(this,'${extCmpId}');">支付勾选院落</span>
            </ul>
        </div>
    </div>
    <div class="tabsContent" layoutH="182">
        <%--待支付院落--%>
        <div></div>
        <%--已支付院落--%>
        <div></div>
