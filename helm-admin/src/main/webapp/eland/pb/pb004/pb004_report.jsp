...
<div>
    <table class="border" style="text-align: center">
        <tr>
            <th>总院落数：</th>
            <td class="js_allBuildNum">${buildNum}</td>
            <th>总公房院落数：</th>
            <td class="js_allPubBuildNum">${pubBuildNum}</td>
            <th>总私房院落数：</th>
            <td class="js_allPriBuildNum">${priBuildNum}</td>
            <th>总公私混合院数：</th>
            <td class="js_allPubPriBuildNum">${pubPriBuildNum}</td>
        </tr>
        <tr>
            <th width="15%">总产籍数：</th>
            ...
            <th width="15%">其他房数：</th>
            <td width="10%">${buildReport.otherHsNum}</td>
        </tr>
        <tr>
            <th>总建筑面积(㎡)：</th>
