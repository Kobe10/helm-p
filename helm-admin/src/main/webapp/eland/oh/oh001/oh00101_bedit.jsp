...
<div>
    <div class="panelBar">
        <ul class="toolBar">
            <li><a class="edit" onclick="Oh00101_bedit.batchSaveOhs()"><span>修改</span></a></li>
            ...
            <tr>
                ...
                <td>
                    <select name="fieldName" style="width: auto;"
                            onchange="Oh00101_bedit.changeCondition(this);">
                    ...
                    等于
                     <span style="position: relative;">
                          <input type="hidden" class="js_real_value"/>
                           <input name="fieldValue" type="text" style="width: 50%;"
                                  atOption="Oh00101_bedit.getOpt" value="" realValue=""
                                  onkeydown="if(event.keyCode == 13){Oh00101_bedit.addField(this);}"
                                  class="autocomplete textInput">
                         </span>
                    <button type="button" class="btn btn-more" onclick="Oh00101_bedit.addField(this);">
                        <i style="font-style:normal;">添加</i>
                    </button>
                    <button type="button" class="btn btn-more" onclick="Oh00101_bedit.clearAll(this);">
...
<script type="text/javascript">
    Oh00101_bedit = {
        ...
        batchSaveOhs: function () {
            ...
            ajaxPacket.data.add("newHsIds", $("input[name=newHsIds]", container).val());
            core.ajax.sendPacketHtml(ajaxPacket, function (response) {
