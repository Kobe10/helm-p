...
<table width="100%">
    <tr>
        <td>
            <oframe:select name="inputCondition" itemCd="MAP_HS_CON" style="width:100%"/>
        </td>
        <td>
        ...
        <td style="width: 45px;">
            <a title="搜索" onclick="fm004Map.loadMapData('search');" style="height: 30px;left:6px;"
               class="btnLook">搜索</a>
            <span onclick="fm004Map.queryHs(this);" title="高级搜索" class="js-more-right"
        ...
        <c:forEach items="${item1.paramName}" var="item" varStatus="varStatus">
            ...
            <td width="50%">
                <div class="colorCheck" onclick="fm004Search.checkCondition(this);">
                    ...
                    <input name="allInputColor" stopClick="true"
                           type="text" value="${item1.color[colorNum]}"
...
<form id="fm004QueryHsForm" class="form" method="post">
