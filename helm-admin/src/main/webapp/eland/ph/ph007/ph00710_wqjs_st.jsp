    ...
    <table width="100%" class="border" style="text-align: center">
            ...
            <tr>
                ...
                <c:choose>
                    <c:when test="${item.Row.hsOwnerType == '0'}">
                        <%--私房--%>
                        <td class="js_result"><oframe:name prjCd="${param.prjCd}" itemCd="FINISH_RESULT" value="${item.Row.procResult4}"/></td>
                        <td><span class="btn" style="color: #0000ff;" onclick="ph007.openWqjs('${hsId}',this);">处理网签、核税、缴税</span></td>
                    </c:when>
                    <c:otherwise>
                        <%--公房--%>
        ...
        <tr style="text-align: center;">
            ...
            <span class="btn-primary marl10"
                  style="padding: 5px 10px; line-height: 34px; cursor:pointer;"
                  onclick="ph007.submitVerifyassignee('ph00710wqjsFrm',this, {})">提交</span>
            </td>
        </tr>
    </table>
</form>