        ...
        <tr>
            ...
            <c:choose>
                <c:when test="${item.Row.hsOwnerType == '0'}">
                    ...
                    <td><oframe:name prjCd="${param.prjCd}" itemCd="DISP_RESULT" value="${item.Row.procResult3}"/></td>
                    <td><span class="btn" style="color: #0000ff" onclick="ph007.viewSfhy('${hsId}')">私房核验结果</span></td>
                </c:when>
                <c:otherwise>
                    <%--公房--%>
