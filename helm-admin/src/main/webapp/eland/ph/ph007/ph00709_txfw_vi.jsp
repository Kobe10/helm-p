...
<table width="100%" class="border" style="text-align: center">
    ...
    <c:forEach items="${hsInfoList}" var="item" varStatus="varStatus">
        <tr>
            ...
            <td><span class="btn" style="color: #0000ff" onclick="ph003Op.chooseHouse('${hsId}', '','view');">选房结果</span></td>
        </tr>
    </c:forEach>
    <tr>
        <th style="width: 10%"><label>备注说明：</label></th>
        <td colspan="4" style="text-align: left; line-height: 50px">${hiTaskInfo.HiTaskInfo.TskBidVars.comment}</td>
    </tr>
</table>