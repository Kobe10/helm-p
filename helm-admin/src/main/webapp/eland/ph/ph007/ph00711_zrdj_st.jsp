    ...
    <table width="100%" class="border" style="text-align: center">
            ...
            <tr>
                ...
                <c:choose>
                    <c:when test="${item.Row.hsOwnerType == '0'}">
                        <%--私房--%>
                        <td class="js_result"><oframe:name prjCd="${param.prjCd}" itemCd="FINISH_RESULT" value="${item.Row.procResult5}"/></td>
                        <td><span class="btn" style="color: #0000ff;" onclick="ph007.openZrdj('${hsId}',this);">办理房屋所有权转移登记</span></td>
                    </c:when>
                    <c:otherwise>
                        <%--公房--%>
        ...
        <tr style="text-align: center;">
            ...
            <span class="btn-primary marl10"
                  ...
                  onclick="ph007.submitVerifyassignee('ph00711Frm',this, {})">提交</span>
            </td>
        </tr>
    </table>
</form>