    ...
    <table width="100%" class="border" style="text-align: center">
        ...
        <c:forEach items="${hsInfoList}" var="item" varStatus="varStatus">
            <tr>
                ...
                <td class="js_result"><oframe:name prjCd="${param.prjCd}" itemCd="FINISH_RESULT" value="${item.Row.procResult10}"/></td>
                <td><span class="btn" style="color: #0000ff;" onclick="ph007.openZffy('${hsId}',this);">处理支付户口外迁费</span></td>
        ...
        <tr style="text-align: center;">
            ...
            <span class="btn-primary marl10"
                  ...
                  onclick="ph007.submitVerifyassignee('ph00717Frm',this, {})">提交</span>
            </td>
        </tr>
    </table>
</form>