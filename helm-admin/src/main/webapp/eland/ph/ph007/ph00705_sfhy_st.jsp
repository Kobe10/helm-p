    ...
    <table width="100%" class="border" style="text-align: center">
            ...
            <tr>
                ...
                <c:choose>
                    <c:when test="${item.Row.hsOwnerType == '0'}">
                        ...
                        <td class="js_result"><oframe:name prjCd="${param.prjCd}" itemCd="DISP_RESULT" value="${item.Row.procResult3}"/></td>
                        <td><span class="btn" style="color: #0000ff;" onclick="ph007.openSfhy('${hsId}',this)">私房核验</span></td>
                    </c:when>
                    <c:otherwise>
                        <%--公房--%>
        ...
        <tr style="text-align: center;">
            ...
            <span class="btn-primary marl10"
                  ...
                  onclick="ph007.submitVerifyassignee('ph00705sfhyFrm',this, {})">提交</span>
            </td>
        </tr>
    </table>
</form>