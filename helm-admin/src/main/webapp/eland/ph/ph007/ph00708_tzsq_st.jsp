    ...
    <table width="100%" class="border" style="text-align: center">
            ...
            <tr>
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <td class="js_result"><oframe:name prjCd="${param.prjCd}" itemCd="FINISH_RESULT" value="${item.Row.procResult2}"/></td>
                        <td><span class="btn" style="color: #0000ff" onclick="ph007.openTzsq('${hsId}', this);">退租申请</span></td>
                    </c:otherwise>
                </c:choose>
            </tr>
        </c:forEach>
        ...
        <tr style="text-align: center;">
            ...
            <span class="btn-primary marl10"
                  ...
                  onclick="ph007.submitVerifyassignee('ph00708Frm', this, {})">提交</span>
            </td>
        </tr>
    </table>
</form>