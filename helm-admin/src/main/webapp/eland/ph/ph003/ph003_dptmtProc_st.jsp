...
<div class="panelBar">
    <ul class="toolBar">
        <c:if test="${hsId != '' && hsId != null}">
            <li><a class="save" onclick="ph00301_task.cmdPassTask('ph003_dept_st','${hsId}', true);"><span>审核通过</span></a></li>
            <li><a class="cancel" onclick="ph00301_task.cmdPassTask('ph003_dept_st','${hsId}', false);"><span>审核不通过</span></a></li>
        </c:if>
    </ul>
</div>
<form id="ph003_dept_st">
