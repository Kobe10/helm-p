...
<div class="tree-bar">
    ...
    <c:choose>
        <c:when test="${objName != '' && objName != null}">
              <span onclick="addrRegTree.onConfim(this);" style="display: block; float: right; margin:0px 10px 5px 0px; cursor: pointer;">确定</span>
        </c:when>
    </c:choose>
</div>
...
<oframe:script src="${pageContext.request.contextPath}/eland/ph/ph003/js/tree.js" type="text/javascript"/>