...
<div class="panel">
    <h1>基本信息
        ...
        <span class="panel_menu" onclick="ph00301.saveOldHsBase(this,'edit');">保存</span>
    </h1>
    <%--面板内容--%>
    <div class="js_panel_context" style="background-color: #ffffff; min-height: 300px;">
        ...
        <div style="width: 59%;height: 100%; display: inline-block; float: right;">
            <form id="ph00301_edit_frm" method="post">
                <table class="border" width="100%">
                    ...
                    <tr>
                        ...
                        <td colspan="3"><textarea type="text" name="hsNote" cols="60" rows="3">${oldHsBean.HouseInfo.hsNote}</textarea>
                        </td>
                    </tr>
                </table>
            </form>
