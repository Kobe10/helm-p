                                                ...
                                                <table border="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td width="30%">
                                                            ...
                                                            <input type="radio"
                                                                   name="qdGfStatus${hsCtChooseId}" ${qdGfStatus1} ${gfhtdisabled}
                                                                   value="1"/>是
                                                            <input type="radio"
                                                                   name="qdGfStatus${hsCtChooseId}" ${qdGfStatus2} ${gfhtdisabled}
                                                                   value="0"/>否
                                                        </td>
                                                        <th width="20%">签约时间：</th>
                                                        <td width="30%"><input type="text" name="qdGfTime"
                                                                               onchange="qdgfht.calcSettlement(this)"
                                                                               class="date required" ${gfhtreadonly} ${gfhtdisabled}
                                                                               value='<oframe:date value="${chooseHs.chooseHs.qdGfTime}" _default="now" format="yyyy-MM-dd"/>'/>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th>居民入住时间：</th>
                                                        <td colspan="3">
                                                            <input type="text" name="rzTime"
                                                                   onchange="qdgfht.calcSettlement(this)"
                                                                   class="date required" ${gfhtreadonly} ${gfhtdisabled}
                                                                   value='<oframe:date value="${chooseHouse.Row.rzTime}" format="yyyy-MM-dd"/>'/>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                                ...
                                                <table border="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td width="30%">
                                                            ...
                                                            <input type="radio"
                                                                   name="jsStatus${hsCtChooseId}" ${jsStatus1} ${gfhtdisabled}
                                                                   value="1"/>是
                                                            <input type="radio"
                                                                   name="jsStatus${hsCtChooseId}" ${jsStatus2} ${gfhtdisabled}
                                                                   value="0"/>否
                                                        </td>
                                                        <th width="20%">结算时间：</th>
                                                        <td width="30%">
                                                            <input type="text"
                                                                   class="date" ${gfhtreadonly} ${gfhtdisabled}
                                                                   value="<oframe:date value="${chooseHouse.Row.jsTime}" _default="now" format="yyyy-MM-dd"/>"
                                                                   name="jsTime"/></td>
                                                    </tr>
                                                    <tr>
                                                        <th>公司承担采暖费：</th>
                                                        <td><input type="text" name="cmpQnCost" ${gfhtreadonly}
                                                                   value="${chooseHouse.Row.cmpQnCost}"/></td>
                                                        <th>公司承担物业费：</th>
                                                        <td><input type="text" name="cmpWyCost" ${gfhtreadonly}
                                                                   value="${chooseHouse.Row.cmpWyCost}"/></td>
                                                    </tr>
                                                    <tr>
                                                        <th>居民承担采暖费：</th>
                                                        <td><input type="text" name="grQnCost" ${gfhtreadonly}
                                                                   value="${chooseHouse.Row.grQnCost}"/></td>
                                                            <%--<th>结算附件材料：</th>--%>
                                                            <%--<td>--%>
                                                            <%--<span class="link marl5 js_doc_info" docTypeName="结算附件材料"--%>
                                                            <%--relType="100"--%>
                                                            <%--onclick="ph008.showDoc(this,'${hsId}')">--%>
                                                            <%--<label style="cursor:pointer;">上传</label>--%>
                                                            <%--<input type="hidden" name="docIds" value='${chooseHouse.Row.jsDocIds}'>--%>
                                                            <%--</span>--%>
                                                            <%--</td>--%>
                                                    </tr>
                                                    <c:if test="${method == 'edit'}">
                                                        <tr>
                                                            <td colspan="4" style="text-align: center"><span
                                                                    ...
                                                                    onclick="ph008.cfmQdht(this);">确认签订购房合同</span>
                                                            </td>
                                                        </tr>
                                                    </c:if>
                                                </table>
        ...
        var qdgfht = {
            calcSettlement: function (obj) {
                ...
                core.ajax.sendPacketHtml(packet, function (response) {
                    ...
                    if (jsonData.success) {
                        if (!rzTime) {
                            $("input[name=rzTime]", thisTable).val(jsonData.rzTime);
                        }
                        $("input[name=cmpQnCost]", thisTable).val(jsonData.cmpQnCost);
                        $("input[name=cmpWyCost]", thisTable).val(jsonData.cmpWyCost);
                        $("input[name=grQnCost]", thisTable).val(jsonData.grQnCost);
                    } else {
