            ...
            <div class="js_panel_context">
                ...
                <table class="border">
                    <tr>
                        ...
                        <td>
                            <input type="radio" name="procResult14" value="审核通过"/>审核通过
                            <input type="radio" name="procResult14" value="审核不通过"/>审核不通过
                        </td>
                    </tr>
                    <tr>
                        <th width="20%"><label>处理时间：</label></th>
                        <td><input class="date" type="text" datefmt="yyyy-MM-dd" name="recordTime14"
                                   value='<oframe:date value="${hsStatus.Row.recordTime14}" format="yyyy-MM-dd"/>'/></td>
                    </tr>
                    <tr>
                        <th><label>备注说明：</label></th>
                        <td style="text-align: left"><textarea rows="5" style="margin: 0px;"
                                                               name="comment14">${hsStatus.Row.comment14}</textarea></td>
                    </tr>
                    <tr style="text-align: center">
                        <td colspan="2">
                            <span class="btn-primary marl10" style="padding: 5px 10px 5px 10px; line-height: 34px; cursor:pointer;"
                                  onclick="ph008.submitZgshTQ(this);">提交</span>
                        </td>
                    </tr>
                </table>
            </div>
