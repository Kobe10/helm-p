            ...
            <div class="js_panel_context">
                ...
                <table class="border">
                    <tr>
                        ...
                        <td><oframe:select prjCd="${param.prjCd}" name="procResult7" itemCd="FINISH_RESULT"
                                           value="${hsStatus.Row.procResult7}"/></td>
                    </tr>
                    <tr>
                        <th width="20%"><label>处理时间：</label></th>
                        <td><input class="date" type="text" datefmt="yyyy-MM-dd" name="recordTime7"
                                   value='<oframe:date value="${hsStatus.Row.recordTime7}" format="yyyy-MM-dd"/>'/></td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="jfAttr1" ${jfAttr1} value="钥匙">钥匙
                            <input type="checkbox" name="jfAttr2" ${jfAttr2} value="拍摄">拍摄
                            <input type="checkbox" name="jfAttr3" ${jfAttr3} value="宣传画">宣传画
                        </td>
                    </tr>
                    <tr>
                        <th><label>备注说明：</label></th>
                        <td style="text-align: left"><textarea rows="5" style="margin: 0px;"
                                                               name="comment7">${hsStatus.Row.comment7}</textarea></td>
                    </tr>
                    <tr style="text-align: center">
                        <td colspan="2">
                            <span class="btn-primary marl10" style="padding: 5px 10px 5px 10px; line-height: 34px; cursor:pointer;"
                                  onclick="ph008.submitTfjf(this);">提交</span>
                        </td>
                    </tr>
                </table>
            </div>
