        ...
        <div class="js_panel_context">
            ...
            <table class="border">
                ...
                <tr>
                    ...
                    <td><oframe:name prjCd="${param.prjCd}" itemCd="DISP_RESULT_206" value="${hsStatus.Row.procResult4}"/></td>
                </tr>
                <tr>
                    <th width="20%"><label>处理时间：</label></th>
                    <td><oframe:date value="${hsStatus.Row.recordTime4}" format="yyyy-MM-dd"/></td>
                </tr>
                <tr>
                    <th><label>备注说明：</label></th>
                    <td style="text-align: left">${hsStatus.Row.comment4}</td>
                </tr>
            </table>
        </div>
    </div>
