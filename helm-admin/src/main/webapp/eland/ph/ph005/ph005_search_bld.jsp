    ...
    <tr>
        ...
        <td>
            <input type="text" name="inputConditionValue"
                   onkeydown="if(event.keyCode==13){ph005Map.loadMapData('search');}"
                   style="width: 100%;height:26px;min-width:initial;">
        </td>
        <td style="width: 45px;">
            <a title="搜索" onclick="ph005Map.loadMapData('search');" style="height: 30px;left:6px;"
               class="btnLook">搜索</a>
            <span onclick="ph005Map.queryBuild(this);" title="高级搜索" class="js-more-right"
        ...
        <c:forEach items="${item1.paramName}" var="item" varStatus="varStatus">
            ...
            <td width="50%">
                <div class="colorCheck" onclick="ph005Search.checkCondition(this);">
                    ...
                    <input name="allInputColor" type="text" value="${item1.color[varStatus.index]}"
...
<form id="ph005QueryBuildForm" class="form" method="post">
