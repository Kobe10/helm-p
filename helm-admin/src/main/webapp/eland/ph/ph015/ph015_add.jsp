        ...
        <form id="ph015frm_spat" method="get">
            ...
            <table class="border">
                <tr>
                    <th width="10%">谈话人：</th>
                    <td width="20%">
                        <input style="float: left" class="required" type="text" name="doRecordPerson" value="${resultList.Row.doRecordPerson}"/>
                    </td>
                    <th width="10%">被谈话人：</th>
                    <td width="20%">
                        <input style="float: left" class="required" type="text" name="recordToPerson" value="${resultList.Row.recordToPerson}"/>
                    </td>
                </tr>
                <tr>
                    <th width="10%">开始时间：</th>
                    <td width="20%">
                        <input style="float: left" type="text"
                               ...
                               class="date required" datefmt="yyyy-MM-dd HH:mm:ss" name="startTime"/>
                    </td>
                    <th width="10%">结束时间：</th>
                    <td width="20%">
                        <input style="float: left" type="text"
                               value='<oframe:date value="${resultList.Row.endTime}" format="yyyy-MM-dd HH:mm:ss"/>'
                               class="date required" datefmt="yyyy-MM-dd HH:mm:ss" name="endTime"/>
                    </td>
                </tr>
                <tr>
                    <th width="10%">内容概述：</th>
                    <td width="20%" colspan="3">
                        <textarea rows="17" name="recordContext"
