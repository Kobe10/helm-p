...
<div class="pageNav">
    <a href="javascript:index.quickOpen('eland/ph/ph001/ph001-init.gv',{opCode:'ph001-init',opName:'居民信息',fresh:true})">居民信息</a>---><a class="current">院落信息</a>---><a
...
<div class="panel" style="margin: 2px 2px">
    <h1>基本信息
        ...
        <span class="panel_menu" onclick="ph00201.saveYardInfo(this, 'add');">保存</span>
    </h1>
    <%--面板内容--%>
    <div id="ph00201_add" class="js_panel_context" style="background-color: #ffffff; min-height: 300px;">
        ...
        <div style="position: relative; display: inline-block; width: 45%; overflow: hidden; float: right;">
            <form id="ph00201_add_frm" method="post">
                <%--基本信息--%>
            ...
            <ul>
                <li style="float: left; margin-left: 40px;">
                    <input type="radio" name="type" value="none" id="noneToggle"
                           onclick="ph00201.toggleControl(this);" checked="checked"/>
                    <label for="noneToggle">导航模式</label>
                </li>
                <li style="float: left; margin-left: 40px;">
                    <input type="radio" name="type" value="polygon" id="polygonToggle"
                           onclick="ph00201.toggleControl(this);"/>
                ...
                <li style="float: left; margin-left: 40px;">
                    <input type="button" onclick="ph00201.alertDrawPoint();" value="查看图形坐标"/>
                </li>
            </ul>
        </div>
    </div>
</div>
<oframe:script src="${pageContext.request.contextPath}/eland/ph/ph002/js/ph00201.js" type="text/javascript"/>
<script>
