...
<div class="panel">
    <h1>基本信息
        ...
        <span class="panel_menu" onclick="ph00201.saveYardInfo(this,'edit');">保存</span>
    </h1>
    <%--面板内容--%>
    <div id="ph00201_edit" class="js_panel_context" style="background-color: #ffffff; min-height: 300px;">
        ...
        <div style="position: relative; display: inline-block; width: 45%; overflow: hidden; float: right;">
            <form id="ph00201_edit_frm" method="post">
            <%--基本信息--%>
