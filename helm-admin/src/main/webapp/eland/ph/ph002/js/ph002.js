var ph002 = {
    openBuild: function (buildId) {
        var url = "eland/ph/ph002/ph002-init.gv";
        index.quickOpen(url, {buldId: buildId},{opCode:"ph002-init",opName:"院落信息",fresh:true});
    },
    ...
    jumpYardS: function () {
        ...
        index.openTab("ph001", "ph001-init", url, "ph001", "居民信息");
    },
