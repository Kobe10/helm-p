...
<div class="panelBar">
    <ul class="toolBar">
        <li><a class="save" onclick="prjRole.saveRole()"><span>保存</span></a></li>
        <c:choose>
            <c:when test="${roleNode.Node.roleCd == null}">
                <li id="pj002RmRoleLi" style="display: none !important;"><a class="delete" onclick="prjRole.removeRole()"><span>删除</span></a></li>
            </c:when>
            <c:otherwise>
                <li><a class="delete" onclick="prjRole.removeRole()"><span>删除</span></a></li>
            </c:otherwise>
        </c:choose>

    </ul>
</div>
<form id="pj002RoleInfoFrm">
    <input type="hidden" name="upNodeId" value="${roleNode.Node.upNodeId}">
    <input type="hidden" name="orgId" value="${roleNode.Node.orgId}">
    <table class="border">
        <tr>
        ...
        <tr>
            <td colspan="2">
                <div layoutH="175">
                    <ul id="prjRoleSltStaffTree" class="ztree"></ul>
                </div>
            </td>
            <td colspan="2" style="margin: 0px;padding: 0px;">
                <div layoutH="168">
                    <ul id="pj002RoleStaff" class="list">
                        <li staffId="" class="hidden">
                            <label style="display: inline-block;"></label>
                                <span onclick="prjRole.dltRoleStaff(this);" style="float: right;"
