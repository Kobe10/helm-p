...
<div class="js_query_condition" style="position: relative;">
    <%--<div class="panelBar">--%>
        <%--<ul class="toolBar">--%>
            ...
            <%--<li>--%>
                <%--<a class="export" onclick="Page.exportExcel('pj016yzf_list', false)">--%>
                    <%--<span>导出EXCEL</span>--%>
                <%--</a>--%>
            <%--</li>--%>
        <%--</ul>--%>
...
<form id="pj016yzfForm">
    ...
    <input type="hidden" name="conditionValue" value="${extCmpId},2">
    <input type="hidden" class="js_conditionValue" value="${extCmpId},">
    <input type="hidden" name="divId" value="pj016yzf_list">
    ...
    <input type="hidden" name="forward" id="forward" value="/eland/pj/pj016/pj016_yzf_list"/>
</form>
...
<script type="text/javascript">
    $(document).ready(function () {
        Page.query($("#pj016yzfForm", navTab.getCurrentPanel()), '');
    });
</script>
