...
<div class="js_query_condition" style="position: relative; margin: 0">
    <%--<div class="panelBar">--%>
        <%--<ul class="toolBar">--%>
            ...
            <%--<li>--%>
                <%--<a class="export" onclick="Page.exportExcel('pj016wzf_list', false)">--%>
                    <%--<span>导出EXCEL</span>--%>
                <%--</a>--%>
            <%--</li>--%>
        <%--</ul>--%>
...
<form id="pj016wzfForm">
    ...
    <input type="hidden" name="divId" value="pj016wzf_list">
    ...
    <input type="hidden" name="forward" id="forward" value="/eland/pj/pj016/pj016_wzf_list"/>
</form>
...
<script type="text/javascript">
    $(document).ready(function () {
        Page.query($("#pj016wzfForm", navTab.getCurrentPanel()));
    });
</script>
