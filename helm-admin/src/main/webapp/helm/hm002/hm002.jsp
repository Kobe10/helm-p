...
<div class="mar5 hm001Div">
    <div style="position: relative;">
        ...
        <form id="hm001form" method="post">
            ...
            <input type="hidden" name="sortColumn" value="publishStatus,publishDate">
            <input type="hidden" name="sortOrder" value="asc,desc">
            ...
            <input type="hidden" name="resultField"
                   value="noticeType,noticeTitle,publishStatus,publishDate">
