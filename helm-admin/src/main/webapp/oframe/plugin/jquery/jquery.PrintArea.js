    ...
    var PrintArea = {
        ...
        getFormData: function (ele) {
            ...
            $("input,select,textarea", ele).each(function (i) {
                ...
                var relLabel = undefined;
                if (typeInput == "radio" || typeInput == "checkbox") {
                    relLabel = copiedInput.next("label:eq(0)");
                    if ($this.is(":checked")) {
                        value = relLabel.html();
                    }
                ...
                if (settings.hideRel) {
                    if ($this.is(":visible")) {
                        $("<label class='dy_print'></label>").html(value).insertBefore(copiedInput);
                    }
                    copiedInput.addClass("js_hidden").hide();
                    if (relLabel) {
                        relLabel.addClass("js_hidden").hide();
                    }
                }
            });
            return copy;
