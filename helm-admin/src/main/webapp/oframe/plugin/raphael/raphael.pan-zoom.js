...
//                me.currPos.y = me.currPos.y + deltaY;
                var tempX = me.currPos.x + deltaX;
                var tempY = me.currPos.y + deltaY;

                var newWidth = paper.width * (1 - (me.currZoom * settings.zoomStep)),
                    newHeight = paper.height * (1 - (me.currZoom * settings.zoomStep));

                //2016 -1- 19 修改不限制拖拽的位置，解决部分图片展示不完整的问题
                // X坐标位置
                //if (tempX > (paper.width * me.currZoom * settings.zoomStep)) {
                //    tempX = (paper.width * me.currZoom * settings.zoomStep);
                //}
                //if (tempX < 0) {
                //    tempX = 0;
                //}
                ...
                //2016 -1- 19 修改不限制拖拽的位置，解决部分图片展示不完整的问题
                //if (tempY > (paper.height * me.currZoom * settings.zoomStep)) {
                //    tempY = (paper.height * me.currZoom * settings.zoomStep);
                //}
                //if (tempY < 0) {
                //    tempY = 0;
                //}
