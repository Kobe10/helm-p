...
<div class="tree-bar">
    ...
    <c:choose>
        <c:when test="${objName != '' && objName != null}">
              <span onclick="sltroleTree.onConfim(this);"
                    style="display: block; float: right; margin:0px 10px 5px 0px; cursor: pointer;">确定</span>
        </c:when>
    </c:choose>
</div>
<div style="width:100%; height:100%; overflow:auto;">
    <ul id="sltroleTreeContainer" class="ztree"></ul>
</div>
<oframe:script src="${pageContext.request.contextPath}/oframe/sysmg/sys004/js/sltroleTree.js" type="text/javascript"/>