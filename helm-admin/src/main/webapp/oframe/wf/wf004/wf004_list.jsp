...
<div class="pageContent">
    <table class="table" border="0" width="100%">
        ...
        <c:forEach items="${returnList}" var="item" varStatus="varStatus">
            ...
            <c:choose>
                <c:when test="${item.Row.procEndTime==null||item.Row.procEndTime==''}">
                    <tr class="${tr_class} js_proc_info" procStUser="${item.Row.procStUser}">
                        ...
                        <td>运行</td>
                        <td>
                            <oframe:power prjCd="${param.prjCd}" rhtCd="revoke_task_name">
                                <input type="hidden" name="revokeTask" value="1">
                            </oframe:power>
                            <span class="link" style="display: none;" name="revoke"
                                  onclick="wf004.Revoke(${item.Row.procInsId});">撤销</span>
                        </td>
                    </tr>
                </c:when>
                <c:otherwise>
