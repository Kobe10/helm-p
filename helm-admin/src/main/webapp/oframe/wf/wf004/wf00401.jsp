    ...
    <div class="tabs mart5 ">
            ...
            <div class="tabsHeaderContent">
                <ul>
                    <li class="selected" onclick="wf004.loadTabContext(1);">
                        <a href="javascript:void(0);"><span>待办任务</span></a>
                    </li>
                    <li onclick="wf004.loadTabContext(2);">
                        <a href="javascript:void(0);"><span>已办任务</span></a>
                    </li>
                </ul>
            </div>
        </div>
        <div class="tabsContent" style="padding: 0;border-top: 1px solid #3d91c8;">
            ...
            <div class="js_star_task" style="position: relative;">
                ...
                <form id="wf00401form01" method="post">
                    <%--自服务名称用于定位SQL--%>
                    <input type="hidden" name="selfDefCmpt" value="QUERY_PROC_TASK_PAGE"/>
                    <%-- 分页展示 --%>
                    <input type="hidden" name="forward" id="forward" value="/oframe/wf/wf004/wf00401_list"/>
                        ...
                        <table class="border">
                            <tr>
                                ...
                                <td style="position: relative;">
                                    ...
                                    <oframe:power prjCd="${param.prjCd}" rhtCd="query_task_name">
                                        <c:set var="haveRht" value="true"/>
                                    </oframe:power>
                                    <c:choose>
                                        <c:when test="${haveRht}">
                                            <input type="text" class="pull-left autocomplete" value="${StaffName}"
                                    ...
                                    <input name="assignee" value="${StaffCd}" type="hidden">
                                </td>
                                <th><label>提交人：</label></th>
                                <td style="position: relative;">
                                    <input type="text" class="pull-left autocomplete" value="" atOption="CODE.getStaffOpt"/>
                                    <%--<input type="text" class="pull-left" value="" onfocus="$(this).next('a').click()"/>--%>
                                    <a title="选择" class="btnLook"
                                       onclick="$.fn.sltStaff(this,{offsetX: 3, fromOp:'wf004', prjCd:getPrjCd()});">选择</a>
                                    <input name="procStUser" value="" type="hidden">
                                </td>
                                <th><label>请求名称：</label></th>
                                <td>
                                    <input name="procInsName" type="text">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="8" align="center">
                                    <button onclick="Query.queryList('wf00401form01', 'wf004_page_data');wf004.closeQSch(1);"
                                            type="button"
                        ...
                        <table class="table" width="100%" layoutH="165">
                            ...
                            <tr>
                                ...
                                <th onclick="Query.sort('wf004_page_data', this);"
                                    defaultSort="desc" sortColumn="createTime" class="sortable">提交时间
                                </th>
                                <th>持续时间</th>
                                <%--<th>当前状态</th>--%>
            ...
            <div class="js_end_task" style="position: relative;">
                ...
                <form id="wf00401form02" method="post">
                    <%--自服务名称用于定位SQL--%>
                    <input type="hidden" name="selfDefCmpt" value="QUERY_PROC_TASK_PAGE"/>
                    <%-- 分页展示 --%>
                    <input type="hidden" name="forward" id="forward" value="/oframe/wf/wf004/wf00401_list"/>
                    ...
                    <div id="wf004End" class="hidden"
                        ...
                        <table class="border">
                            <tr>
                                ...
                                <th><label>提交人：</label></th>
                                <td style="position: relative;">
                                    <input type="text" class="pull-left autocomplete" value=""
                                           atOption="CODE.getStaffOpt"/>
                                    <a title="选择" class="btnLook"
                                       onclick="$.fn.sltStaff(this,{offsetX: 3, fromOp:'wf004', prjCd:getPrjCd()});">选择</a>
                                    <input name="procStUser" value="" type="hidden">
                            ...
                            <tr>
                                <td colspan="8" align="center">
                                    <button onclick="Query.queryList('wf00401form02', 'wf00402_page_data');wf004.closeQSch(2);"
                                            type="button"
                        ...
                        <table class="table" width="100%" layoutH="165">
                            ...
                            <tr>
                                ...
                                <th onclick="Query.sort('wf00402_page_data', this);"
                                    sortColumn="createTime" class="sortable">提交时间
                                </th>
                                <th onclick="Query.sort('wf00402_page_data', this);"
                                    defaultSort="desc" sortColumn="endTime" class="sortable">完成时间
                                </th>
                            </tr>
                            </thead>
                            <tbody>
