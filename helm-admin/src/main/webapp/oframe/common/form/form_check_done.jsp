...
<div>
    ...
    <div>
        ...
        <form id="form_check_form" method="post" class="required-validate">
            ...
            <table class="border">
                <tr>
                    <th width="20%"><label>审批结果：</label></th>
                    <td>
                        <oframe:select type="radio" id="formCheckResult" cssClass="marr5" name="checkResult"
                                       itemCd="CHECK_OPTIN" prjCd="${prjCd}"/>
                    </td>
                </tr>
                <tr>
    ...
    <div class="panel">
        ...
        <div>
            <form id="_formApplyfrm" method="get">
                <input type="hidden" name="tableLayOut" value="365"/>
                ...
                <input type="hidden" name="conditionValue" value="${checkRelType},${checkRelId}">
                ...
                <input type="hidden" name="resultField"
                       value="checkStaff,checkTime,checkResult,checkNote,checkOpName,modifyTransactionId">
            ...
            <div id="form_check_apply_list" class="js_page" layoutH="285"></div>
        </div>
    </div>
</div>
