        ...
        <ul id="ul00">
            <li class="j-first">
                <input class="textInput" name="pageSize"
                       ...
                       onkeydown="{if(event.keyCode == 13){Query.jumpPage(1,'${divId }');}}"/>
            </li>
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <li class="j-first"><a href="javascript:Query.jumpPage(1,'${divId }','${divPId }')"
                                           class="first" title="首页"><span>首页</span></a></li>
                    <li class="j-prev"><a
                            href="javascript:Query.jumpPage('${pagination.currentPage - 1}','${divId }','${divPId }')"
            ...
            %>
            <li class="j-num"><a href="javascript:Query.jumpPage(<%=i%>,'${divId }','${divPId }')"><%=i%>
            </a></li>
            <%
                    }
                }
            ...
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <li class="j-last"><a
                            href="javascript:Query.jumpPage('${pagination.totalPage}','${divId }','${divPId }')"
            ...
            <li class="jumpto"><input class="textInput" name="skipToNo"
                                      ...
                                      onkeydown="{if(event.keyCode == 13){Query.skipTo('${divId }','${divPId }');}}"/>
                <input
                        class="goto" type="button" onclick="javascript:Query.skipTo('${divId }','${divPId }');"
                        title="跳转"></li>
